            ...
            <section className="bg-gradient-to-br from-orange-300 to-rose-600 h-screen">
                ...
                <main className='flex flex-col items-center gap-5'>
                    ...
                    <div>
                        ...
                        <input className='h-10 w-96 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300' type="number" id={rondas} required />
                    </div>
                    <div>
                        <label className='font-semibold' htmlFor={vidas}>Vidas: </label><br />
                        <input className='h-10 w-96 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300' type="number" id={vidas} required />
                    </div>
                </main>
